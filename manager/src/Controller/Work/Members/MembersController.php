...
/**
 * @Route("/work/members", name="work_members")
...
class MembersController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/archive", name="_archive", methods={"POST"})
     * @param Member $member
     * @param Request $request
    ...
    /**
     * @Route("/{id}/reinstate", name="_reinstate", methods={"POST"})
     * @param Member $member
     * @param Request $request
